...
public class EnergyResultsStepDef extends Common {
	...
	public void i_check_postcode_i_have_entered_displayed_under_supplier_details_section(String postcode)
			throws Throwable {
	...
	public void i_check_if_it_is_showing_as_my_electricity_supplier_under_supplier_details_section(
			String electricitySupplier) throws Throwable {
	...
	public void i_check_if_it_is_showing_Projection_as_under_energy_usage_section(String elecProjection)
			throws Throwable {
		assertTrue("Projection does not contain " + elecProjection + " ",
				EnergyResultsPlatformPage.getElectricityProjection(elecProjection).contains(elecProjection));
	}

	@Then("^I check if it is showing \"([^\"]*)\" as my gas supplier under supplier details section$")
	public void i_check_if_it_is_showing_as_my_gas_supplier_under_supplier_details_section(String gasSupplier)
			throws Throwable {
	...
	public void i_check_if_it_is_showing_as_my_default_gas_supplier_under_supplier_details_section(String gasSupplier)
			throws Throwable {
	...
	@Then("^I see filter results heading as \"([^\"]*)\" on leftside$")
	public void i_see_filter_results_heading_as_on_leftside(String filterHeading) throws Throwable {
	...
	public void i_check_if_Fixed_tariff_type_checkbox_is_checked_under_Personalise_your_results_section()
			throws Throwable {
	...
	public void i_check_if_Fixed_tariff_type_checkbox_is_unchecked_under_Personalise_your_results_section()
			throws Throwable {
	...
	public void i_check_if_Variable_tariff_type_checkbox_is_checked_under_Personalise_your_results_section()
			throws Throwable {
	...
	public void i_check_if_Variable_tariff_type_checkbox_is_unchecked_under_Personalise_your_results_section()
			throws Throwable {
	...
	public void i_check_if_Monthly_Payment_type_checkbox_is_checked_under_Personalise_your_results_section()
			throws Throwable {
		assertTrue("MONTHLY PAYMENT TYPE CHECKBOX UNCHECKED ",
				EnergyResultsPlatformPage.monthlyPayTypeChecked() == true);
	}

	@Then("^I check if Monthly Payment type checkbox is unchecked under Personalise your results section$")
	public void i_check_if_Monthly_Payment_type_checkbox_is_unchecked_under_Personalise_your_results_section()
			throws Throwable {
		assertTrue("MONTHLY PAYMENT TYPE CHECKBOX CHECKED ",
				EnergyResultsPlatformPage.monthlyPayTypeUnchecked() == true);
	}

	@Then("^I check if Quarterly Payment type checkbox is unchecked under Personalise your results section$")
	public void i_check_if_Quarterly_Payment_type_checkbox_is_unchecked_under_Personalise_your_results_section()
			throws Throwable {
		assertTrue("QUARTERLY PAYMENT TYPE CHECKBOX CHECKED ",
				EnergyResultsPlatformPage.quarterlyPayTypeUnchecked() == true);
	}

	@Then("^I check if Pay on receipt of bill Payment type checkbox is unchecked under Personalise your results section$")
	public void i_check_if_Pay_on_receipt_of_bill_Payment_type_checkbox_is_unchecked_under_Personalise_your_results_section()
			throws Throwable {
		assertTrue("PAY ON RECEIPT OF BILL PAYMENT TYPE CHECKBOX CHECKED ",
				EnergyResultsPlatformPage.payonReceiptOfBillPayTypeUnchecked() == true);
	}
	...
	public void i_see_heading_available_next_to_Annual_saving_heading(String estimatedBillheadingTitle)
			throws Throwable {
	...
	public void i_See_heading_available_next_to_Payment_type_heading(String supplierRatingHeadingTitle)
			throws Throwable {
